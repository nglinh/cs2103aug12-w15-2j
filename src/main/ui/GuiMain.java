...
public class GuiMain extends GuiCommandBox{
	...
	public static GuiMain getInstance() {
		LogHandler.getLogInstance().info("Getting instance of GuiMain");
		if (theOne == null) {
			LogHandler.getLogInstance().info(
					"Instance does not exist, creating GuiMain");
			theOne = new GuiMain();
		}
		return theOne;
	}
	...
	protected void initialize() {
		...
		frmDoit.setIconImage(Toolkit.getDefaultToolkit().getImage(GuiMain.class.getResource("/resource/icon.png")));
		...
		btnUndo.setIcon(new ImageIcon(GuiMain.class.getResource("/resource/arrow_undo.png")));
		...
		btnHome.setIcon(new ImageIcon(GuiMain.class.getResource("/resource/house.png")));
		...
		tglbtnAgendaView.setIcon(new ImageIcon(GuiMain.class.getResource("/resource/calendar_view_day.png")));
		...
		tglbtnListView.setIcon(new ImageIcon(GuiMain.class.getResource("/resource/calendar_view_week.png")));
		...
		btnHelp.setIcon(new ImageIcon(GuiMain.class.getResource("/resource/help.png")));
		...
		btnPreferences.setIcon(new ImageIcon(GuiMain.class.getResource("/resource/wrench_orange.png")));
		...
		btnNewButton.setIcon(new ImageIcon(GuiMain.class.getResource("/resource/arrow_undo.png")));
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					//e.printStackTrace();
					log.log(Level.WARNING, "Error launching GuiMain", e);
				}
			}
		});
